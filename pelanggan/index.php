...
<section class="hedaer py-5" style="background: url('../assets/file/bandeng.jpg'); background-size:cover; background-position: center center;">
	<div class="container py-5">
		<div class="row">
			<div class="col-md-6">
				<h4 class="mb-4 text-white text-uppercase"><strong>SELAMAT DATANG DI RINDANG 84 JUWANA</strong></h4>
				<h1 style="color: white;" class="mb-4"><strong>Menjual berbagai macam produk olahan ikan bandeng</strong></h1>
				...
				<div class="d-inline">
					<a href="riwayat.php" class="btn btn-success text-white"><strong> <span class=" bi bi-chevron-double-right"></span>RIWAYAT BELANJA </strong></a>
				</div>
			</div>
		</div>
	</div>
