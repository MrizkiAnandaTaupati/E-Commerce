        ...
        // Simpan ke tabel pembelian
        	...
        	// Simpan ke tabel pembelian_produk
					foreach ($keranjang as $key => $value) {
						...
						$koneksi->query("INSERT INTO pembelian_produk (id_pembelian, id_produk, jumlah_beli, nama_beli, harga_beli, berat_beli, subharga_beli, subberat_beli) VALUES ('$id_pembelian', '$id_produk', '$jumlah_beli', '$nama_beli', '$harga_beli', '$berat_beli', '$subharga_beli', '$subberat_beli')");
